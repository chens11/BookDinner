...
- (void)getPersonInfo{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@%@",KAPI_ServerUrl,KAPI_ActionGetPersonInfo];
    ...
    formRequest.userInfo = [NSDictionary dictionaryWithObjectsAndKeys:KAPI_ActionGetPersonInfo,HTTP_USER_INFO, nil];
