...
#define KAPI_ActionResetPassWord                         @"API/?c=user&a=getpassword"
...
#define KAPI_ActionGetAddressProvince                    @"API/?c=server&a=getprovince"
#define KAPI_ActionGetAddressCity                        @"API/?c=server&a=getcity"
#define KAPI_ActionGetAddressBlock                       @"API/?c=server&a=getdistrict"
...
#define KAPI_ActionPayOrder                              @"API/?c=product&a=addorder"
#define KAPI_ActionGetOrderList                          @"API/?c=product&a=getorder"
#define KAPI_ActionLuckyDraw                             @"API/?c=ticker&a=dazhuanpan"
#define KAPI_ActionLuckyDrawList                         @"API/?c=ticker&a=getticker"
#define KAPI_ActionGetOrderDetail                        @"API/?c=product&a=getorderid"
#define KAPI_ActionGetRechargeRecordList                 @"API/?c=user&a=getmoney"
#define KAPI_ActionRecharge                              @"API/?c=user&a=money"
