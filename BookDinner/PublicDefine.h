...
#define ActionGetAddressList                         @"API/?c=user&a=getaddress"
...
//#define ActionLoginActionCheckAccountPhone          @"loginAction!checkAccountPhone.action"
//#define ActionGetWeatherInfo                        @"loginAction!getWeatherInfo.action"
//#define ActionVersionsGetLastVersion                @"versions!getLastVersion.action"
//#define ActionVersionsGetShare                      @"versions!getShare.action"
//#define ActionGetHomeContentImgList                 @"columnContent!getHomeContentImgList.action"
//#define ActionGetBusinessList                       @"columnContent!titles.action"
//#define ActionGetSubColumnList                      @"columnContent!subColumnList.action"
//#define ActionGetColumnContentDetail                @"columnContent!detail2.action"
//#define ActionAppealSaveAppealPopularity            @"appeal!saveAppealPopularity.action"
//#define ActionAppealPublishAppealComment            @"appeal!publishAppealComment.action"
//#define ActionAppealPublishAppeal                   @"appeal!publishAppeal.action"
//#define ActionAppealAppealComment                   @"appeal!getAppealComment.action"
//#define ActionAppealGetMyAppealList                 @"appeal!getMyAppeal.action"
//#define ActionAppealAllMyAppealList                 @"appeal!getAllAppeal.action"
//#define ActionAppealGetAppeal                       @"appeal!getAppeal.action"
//#define ActionAppealDeleteMyAppealComment           @"appeal!deleteMyAppeal.action"
